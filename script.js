...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Global functions defined:', {
        showGearCheck: typeof window.showGearCheck,
        showChecklist: typeof window.showChecklist,
        resetChecklist: typeof window.resetChecklist,
        returnToMode: typeof window.returnToMode,
